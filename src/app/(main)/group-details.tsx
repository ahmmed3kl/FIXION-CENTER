...
const styles = StyleSheet.create({
  ...
  scheduleItem: { backgroundColor: Colors.white, borderRadius: 15, padding: 13, minWidth: "45%", borderWidth: 1, borderColor: Colors.border },
  ...
  studentRow: { flexDirection: "row", alignItems: "center", backgroundColor: Colors.white, padding: Spacing.lg, borderRadius: 17, marginBottom: 8, borderWidth: 1, borderColor: Colors.border },
