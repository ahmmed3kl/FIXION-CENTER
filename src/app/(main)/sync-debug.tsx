...
const styles = StyleSheet.create({
  ...
  statCard: { width: "48%", backgroundColor: Colors.white, borderRadius: 17, padding: Spacing.lg, borderWidth: 1, borderColor: Colors.border, alignItems: "center" },
  ...
  operationCard: { backgroundColor: Colors.white, borderRadius: 17, borderWidth: 1, borderColor: Colors.border, padding: Spacing.lg, gap: 5 },
