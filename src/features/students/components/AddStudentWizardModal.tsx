...
export const AddStudentWizardModal: React.FC<AddStudentWizardModalProps> = ({ visible, onClose, onStudentCreated }) => {
  ...
  const filteredTeachers = useMemo(
    () => {
      ...
      return smartSearch(
        teachers.filter((teacher) => teacher.status !== "inactive" && (!grade || gradeTeacherIds.has(teacher.id))),
        teacherSearch,
        ...
        <SafeAreaView style={styles.sheet}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
            ...
            <Section icon="person-outline" title="بيانات الطالب">
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.gradeRow}>{allGrades.map((item) => <TouchableOpacity key={item} onPress={() => selectGrade(item)} style={[styles.gradeChip, grade === item && styles.gradeChipActive]}><Text style={[styles.gradeChipText, grade === item && styles.gradeChipTextActive]}>{item}</Text></TouchableOpacity>)}</ScrollView>
...
const createStyles = (colors: typeof Colors) => StyleSheet.create({
  ...
  content: { padding: 12, paddingBottom: 28, backgroundColor: colors.background },
  section: { backgroundColor: colors.slate50, borderRadius: 17, padding: 12, marginBottom: 10 },
  ...
  sectionTitleWrap: { flex: 1, alignItems: "flex-start" }, sectionTitle: { color: colors.slate900, fontWeight: "800", fontSize: 17, textAlign: "right" }, sectionHint: { color: colors.slate500, fontSize: 11, marginTop: 1, textAlign: "right" }, countBadge: { minWidth: 25, height: 25, borderRadius: 13, paddingHorizontal: 7, backgroundColor: colors.primaryLight, alignItems: "center", justifyContent: "center" }, countBadgeText: { color: colors.primary, fontSize: 13, fontWeight: "800" },
  ...
  field: { marginBottom: 9 }, compactInput: { height: 43, minHeight: 43, borderRadius: 11, backgroundColor: colors.cardBackground, borderColor: colors.border, fontSize: 14, paddingHorizontal: 12 },
  ...
  groupCard: { backgroundColor: colors.cardBackground, borderWidth: 1, borderColor: colors.border, borderRadius: 13, padding: 10, marginBottom: 7, flexDirection: "row-reverse", alignItems: "flex-start", gap: 9 }, groupCardSelected: { borderColor: colors.primary, backgroundColor: colors.primaryMuted }, checkBox: { width: 24, height: 24, borderRadius: 7, borderWidth: 1.5, borderColor: colors.slate400, alignItems: "center", justifyContent: "center", marginTop: 1 }, checkBoxSelected: { backgroundColor: colors.primary, borderColor: colors.primary }, groupInfo: { flex: 1, alignItems: "flex-end" }, groupName: { color: colors.slate900, fontWeight: "800", fontSize: 14, textAlign: "right" }, groupMeta: { color: colors.slate500, fontSize: 11, marginTop: 2, textAlign: "right" }, timeLine: { flexDirection: "row-reverse", alignItems: "center", gap: 4, marginTop: 4 }, timeText: { color: colors.slate500, fontSize: 10 }, emptyText: { color: colors.slate500, textAlign: "center", fontSize: 12, paddingVertical: 9 },
